var DishType = (function() {
    ...
    return {
         ...
         */
        init: function() {
            DishType.getDishTypes();
            DishType.changeStatus();
            DishType.destroyRecord();
            DishType.updateOrder();
            DishType.initializeComponents();
            DishType.viewDescription();
        },
        ...
        getDishTypes: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    DishType.updateDataTableSelectAllCtrl(table);
        ...
        updateOrder: function() {
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $(".dataTable tbody tr").each(function(index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var dishTypeOrder = $('#dish_type_order_'+rowId.id).val();
                    innerArray.push(rowId.id, dishTypeOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
