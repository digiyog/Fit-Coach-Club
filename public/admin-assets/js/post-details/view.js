var Post = (function() {
    ...
    return {
        ...
        init: function() {
            ...
            Post.destroyRecord();
            Post.updateOrder();
            Post.initializeComponents();
            Post.dataTableCustomFilter();
        },
        ...
        getPosts: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Post.updateDataTableSelectAllCtrl(table);
        ...
        updateOrder: function() {
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $(".dataTable tbody tr").each(function(index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var PostOrder = $('#categories_order_'+rowId.id).val();
                    innerArray.push(rowId.id, PostOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
