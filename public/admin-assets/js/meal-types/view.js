var MealType = (function() {
    ...
    return {
        ...
        init: function() {
            ...
            MealType.changeStatus();
            MealType.destroyRecord();
            MealType.updateOrder();
            MealType.initializeComponents();
            MealType.viewDescription();
        },
        ...
        getMealTypes: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    MealType.updateDataTableSelectAllCtrl(table);
        ...
        updateOrder: function() {
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $(".dataTable tbody tr").each(function(index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var mealTypeOrder = $('#meal_type_order_'+rowId.id).val();
                    innerArray.push(rowId.id, mealTypeOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
