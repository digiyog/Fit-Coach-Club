var CustomDish = (function() {
    ...
    return {
         ...
         */
        init: function() {
            CustomDish.getCustomDishes();
            CustomDish.changeStatus();
            CustomDish.destroyRecord();
            CustomDish.updateOrder();
            CustomDish.initializeComponents();
            CustomDish.viewDescription();
        },
        ...
        getCustomDishes: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    CustomDish.updateDataTableSelectAllCtrl(table);
        ...
        updateOrder: function() {
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $(".dataTable tbody tr").each(function(index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var customDishOrder = $('#custom_dish_order_'+rowId.id).val();
                    innerArray.push(rowId.id, customDishOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
