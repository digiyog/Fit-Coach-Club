var MembershipPlan = (function() {
    return {
         ...
         */
        init: function() {
            MembershipPlan.validateMembershipPlanForm();
            MembershipPlan.initializeComponents();
            MembershipPlan.customValidationMethods();
        },
        ...
        /**
         * Validate Membership Plan form.
         */
        validateMembershipPlanForm: function() {
            var $form = $(".membership-plan-form");
