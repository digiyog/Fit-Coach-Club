var Framework = (function() {
    ...
    return {
        ...
        initializeComponents: function() {
            // Agency filter form
            var $agency_filter_form = $(".agency-filter-form");
            Components.bootstrapSelect($agency_filter_form);
            //-------------------
        },
        ...
        getFramework: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.filter_agency = $("select[name=filter_agency]").val();
                    }
                },
                ///.add here the values that needed to be shown in the table
                columns: [
                    {
                        data: null,
                        name: "",
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Framework.updateDataTableSelectAllCtrl(table);
