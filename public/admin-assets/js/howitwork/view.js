var HowItWork = (function () {
    ...
    return {
         ...
         */
        init: function () {
            HowItWork.getHowItWork();
            HowItWork.changeStatus();
            HowItWork.destroyRecord();
            HowItWork.updateOrder();
        ...
        /**
         * Get How it Work list.
         */
        getHowItWork: function () {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    // data: function(d) {
                    //     d.name = $("select[name=language_name]").val();
                    // }
                },
                columns: [
                    {
                    ...
                    { data: "name", name: "name" },
                    { data: "arabic_title", name: "arabic_title" },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function (e) {
                    ...
                    HowItWork.updateDataTableSelectAllCtrl(table);
        ...
        updateOrder: function () {
            ...
            $data_table_container.on("click", ".update-order", function () {
                ...
                $(".dataTable tbody tr").each(function (index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var HowItWorkOrder = $('#how_it_work_order_' + rowId.id).val();
                    innerArray.push(rowId.id, HowItWorkOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
