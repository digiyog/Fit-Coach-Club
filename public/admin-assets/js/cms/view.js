var Cms = (function() {
    ...
    return {
        ...
        //     // if(viewPermission == 1 && (editPermission == 1 || deletePermission == 1)){
        ...
        getCms: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columnDefs: [
                    {
                        ...
                        // orderable: !1,
                        // visible: 
                        // // (viewPermission == 1 && (editPermission == 1 || deletePermission == 1)) 
                        // 1 == 1
                        // ? true : false,
                ...
                columns: [
                    // { data: null, name: "", searchable: false, sortable: false },
