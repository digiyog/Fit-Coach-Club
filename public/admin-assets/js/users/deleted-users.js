        ...
        initializeComponents: function() {
            ...
            $('input[name="date_range"]').on(
                ...
                function (ev, picker) {
                    ...
                    $filter_form.find(':input[name="filter"]').prop("disabled", false);
                    $filter_form.find(':input[name="clear"]').prop("disabled", false);
                    $filter_form.find('a.clear-filter').removeClass("disabled");
                }
            );
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.email = $("#email").val();
                        d.m_no = $("#m_no").val();
                        d.filter_platform = $("#platform_filter").val();
