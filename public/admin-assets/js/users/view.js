var User = (function() {
    ...
    return {
        ...
        init: function() {
            ...
            User.dataTableCustomFilter();
            User.editUserQuick();
            User.customValidationMethods();
            User.validateUserForm();
            User.addUserDays();
            User.validateAddUserDaysForm();
            User.subtractUserDays();
            User.validateSubtractUserDaysForm();
        },
        ...
        updateOrder: function() {
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $(".dataTable tbody tr").each(function(index, rowId) {
                    ...
                    var rowId = data;
                    rows_selected.push(rowId);
                    var userOrder = $('#user_order_'+rowId.id).val();
                    innerArray.push(rowId.id, userOrder);
                    ids.push(innerArray);
                });
                $.ajax({
                    type: "POST",
         ...
         * Edit User Quick.
         */
        editUserQuick: function () {
            var $source = $(".data-table-container");
            $source.on("click", ".edit-user-quick", function () {
         ...
         * Add User Days
         */
        addUserDays: function () {
            var $source = $(".data-table-container");
            $source.on("click", ".add-user-days", function () {
        ...
        /**
         * Validate Add User Days Form
         */
        validateAddUserDaysForm: function() {
            var $form = $(".add-user-days-form");
         ...
         * Subtract User Days
         */
        subtractUserDays: function () {
            var $source = $(".data-table-container");
            $source.on("click", ".subtract-user-days", function () {
        ...
        /**
         * Validate Subtract User Days Form.
         */
        validateSubtractUserDaysForm: function() {
            var $form = $(".subtract-user-days-form");
