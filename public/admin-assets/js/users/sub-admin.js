...
var User = (function() {
    return {
        ...
        initializeComponents: function() {
            var $addForm = $('.add-sub-admin-form');
            var $editForm = $('.edit-sub-admin-form');
        ...
        /**
         * Validate Add Sub Admin form.
         */
        validateForm: function() {
            var $form = $(".add-sub-admin-form");
        ...
        checkPermissionsByModule: function() {
            var addForm = $(".add-sub-admin-form, .edit-sub-admin-form");
