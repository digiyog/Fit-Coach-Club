var Testimonial = (function() {
    ...
    return {
        ...
        getTestimonials: function() {
            ...
            data_table = table = $dataTable.DataTable({
                headerCallback: function(e, a, t, n, s) {
                    ...
                    if (th) {
                        th.innerHTML =
                            '<label class="new-control new-checkbox checkbox-outline-primary m-auto">\n<input type="checkbox" name="select_all" class="new-control-input chk-parent" id="test-select-all">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>';
                    }
                },
                columnDefs: [
                    {
                        ...
                        render: function(e, a, t, n) {
                            return '<label class="new-control new-checkbox checkbox-outline-primary m-auto">\n<input type="checkbox" class="new-control-input child-chk" id="test_chk_' + t.id + '">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>';
                        }
                    }
                ],
                buttons: {
                ...
                oLanguage: {
                    ...
                    sZeroRecords: "No matching testimonials found"
                },
                processing: true,
                serverSide: true,
                lengthMenu: [
                ...
                pageLength: 20,
                dom: '<"row"<"col-md-12"rt><"col-md-12"<"d-flex align-items-center justify-content-between flex-wrap gap-2 pt-3 px-2"<"test-info-wrap"i><"test-paginate-wrap"p>>>>',
                ajax: {
                ...
                columns: [
                    ...
                    { data: "name", name: "name" },
                    { data: "story_type", name: "link" },
                    { data: "media", name: "image" },
                    { data: "display_channels", name: "status" },
            ...
            $dataTable.find("tbody").on("click", 'input[type="checkbox"]', function(e) {
                ...
                Testimonial.updateActionButtons();
                e.stopPropagation();
            });
            ...
            table.on("draw", function() {
                ...
                $("#test-count-text").text(info.recordsTotal + " testimonials");

                // Toggle Empty State when no records exist and no search filter applied
                var hasSearch = $("#test-search-input").val().trim().length > 0;
                var hasFilter = $("#filter-format").val() !== "" || $("#filter-channel").val() !== "" || $("#filter-status").val() !== "";

                if (info.recordsTotal === 0 && !hasSearch && !hasFilter) {
                    $(".data-table-container").hide();
                    $("#test-empty-state").show();
                } else {
                    $(".data-table-container").show();
                    $("#test-empty-state").hide();
                }
        ...
        initFilters: function() {
            ...
            $("#test-search-input").on("input keyup", function() {
                var val = $(this).val();
            ...
            // Filter dropdowns
            $("#filter-format, #filter-channel, #filter-status").on("change", function() {
                data_table.ajax.reload();
            });

            // Per page dropdown
            $("#test-page-length").on("change", function() {
        ...
        changeStatus: function() {
            var $data_table_container = $(".test-main-card");
            var $dataTable = $("#dataTable");
            ...
            $data_table_container.on("click", ".dt-delete", function() {
                ...
                if (typeof iziToast !== "undefined") {
                    iziToast.question({
                        ...
                        zindex: 99999,
                        title: "Hey!",
                        message: "Are you sure you want to delete the selected testimonials?",
                        position: "center",
                        progressBar: false,
                        buttons: [
                            [
            ...
            $data_table_container.on("click", ".update-order", function() {
                ...
                $("#dataTable tbody tr").each(function(index, elem) {
                    ...
                    if (data && data.id) {
                        ...
                        ids.push([data.id, testimonialOrder]);
                    }
                });
