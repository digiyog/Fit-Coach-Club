...
@section('page-title', ' Edit Activity | '.__('language.page_main_title').'')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="container-fluid mt2">
                        ...
                        <div class="form pb-2">
                            {!! Form::open(['class' => 'activity-form', 'method' => 'post', 'url' => route('nutritionPanel.activities.update', ['id' => ev($activity->id)]), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    
                                    @php
                                        $imagePath = (get_image_url(config('constants.activities.image_path'), $activity->image) ?? '');
                                    @endphp
                                    ...
                                    <div class="col-md-3">
                                        <div class="custom-dropify">
                                            ...
                                            {!! Form::hidden('image_name', old('image_name', ($activity->image ?? null)) ,['class' => 'form-control','id' => 'image_name']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="row pr-3">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::text('name', $activity->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Name', ]) !!}
                                            </div>

                                            <div class="col-md-6 mt-3">
                                                <label for="activity_type">Activity Type</label>
                                                {!! Form::select('activity_type', create_select_options(config('constants.activity_type'), 'display', 'value', 'Select Activity Type'), $activity->activity_type, ['class' => 'form-control select-picker', 'id' => 'activity_type' ]) !!}
                                            </div>

                                            <div class="col-md-6 mt-3">
                                                <label for="date">Date</label>
                                                {!! Form::text('date', '', ['class' => 'form-control date-picker', 'id' => 'date', 'placeholder' => 'Select Date' ]) !!}
                                            </div>

                                            <div class="col-md-12 mt-3">
                                                <label for="order"> Order <span class="text-danger">*</span></label>
                                                {!! Form::text('order', $activity->order, ['class' => 'form-control numeric', 'id' => 'order', 'placeholder' => 'Order', ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ asset('admin-assets/js/activities/activities.js') }}"></script>
