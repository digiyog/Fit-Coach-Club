...
@section('page-title', ' Create Activity | '.__('language.page_main_title').'')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="container-fluid mt2">
                        ...
                        <div class="form pb-2">
                            {!! Form::open(['class' => 'activity-form', 'method' => 'post', 'url' => route('nutritionPanel.activities.store'), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row pe-3">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                ...
                                                {!! Form::select('activity_type', create_select_options(config('constants.activity_type'), 'display', 'value', 'Select Activity Type'), '', ['class' => 'form-control select-picker', 'id' => 'activity_type' ]) !!}
                                            </div>
