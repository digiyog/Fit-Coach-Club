...
@section('page-title', 'Shake Intakes | '.__('language.page_main_title').'')
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('nutritionPanel.shake-intakes.getShakeIntakes') }}">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Name</th>
...
<script src="{{ asset('admin-assets/js/shake-intakes/view.js') }}"></script>
@endpush
