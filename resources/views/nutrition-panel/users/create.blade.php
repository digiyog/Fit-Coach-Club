                            ...
                            {!! Form::open(['class' => 'user-form', 'method' => 'post', 'url' => route('nutritionPanel.users.store'), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {!! Form::email('email', '', ['class' => 'form-control', 'id' => 'email', 'placeholder' => 'Email', 'autocomplete' => 'off', 'data-url' => route('nutritionPanel.users.checkEmail', ['id' => $user->id]) ]) !!}
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-3">
                                                ...
                                                {!! Form::select('product_type_id', create_select_options($productTypes, 'name', 'id', 'Select Product Type'), '', ['class' => 'form-control select-picker', 'id' => 'product_type_id' ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        {!! Form::text('date_of_birth', '', ['class' => 'form-control date-picker', 'id' => 'date_of_birth', 'placeholder' => 'Select Date of Birth' ]) !!}
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        {!! Form::number('weight_goal', '', ['class' => 'form-control', 'id' => 'weight_goal', 'placeholder' => 'Enter Weight Goal(In Kg)', 'autocomplete' => 'off', 'min' => '0', 'max' => '99' ]) !!}
                                    </div>
