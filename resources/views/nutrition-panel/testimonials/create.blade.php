...
@section('page-title', ' Create Testimonial | '.__('language.page_main_title').'')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="container-fluid mt2">
                        ...
                        <div class="form pb-2">
                            {!! Form::open(['class' => 'testimonial-form', 'method' => 'post', 'url' => route('nutritionPanel.testimonials.store'), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row pe-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                {!! Form::text('link', '', ['class' => 'form-control', 'id' => 'link', 'placeholder' => 'Video Link', ]) !!}
                                            </div>
