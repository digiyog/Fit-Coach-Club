...
@section('page-title', ' Edit Testimonial | '.__('language.page_main_title').'')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="container-fluid mt2">
                        ...
                        <div class="form pb-2">
                            {!! Form::open(['class' => 'testimonial-form', 'method' => 'post', 'url' => route('nutritionPanel.testimonials.update', ['id' => ev($testimonial->id)]), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    
                                    @php
                                        $imagePath = (get_image_url(config('constants.testimonials.image_path'), $testimonial->image) ?? '');
                                    @endphp
                                    ...
                                    <div class="col-md-3">
                                        <div class="custom-dropify">
                                            ...
                                            {!! Form::hidden('image_name', old('image_name', ($testimonial->image ?? null)) ,['class' => 'form-control','id' => 'image_name']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="row pr-3">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::text('name', $testimonial->name, ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Name', ]) !!}
                                            </div>

                                            <div class="col-md-12 mt-3">
                                                <label for="link">Video Link <span class="text-danger">*</span></label>
                                                {!! Form::text('link', $testimonial->link, ['class' => 'form-control', 'id' => 'link', 'placeholder' => 'Video Link', ]) !!}
                                            </div>

                                            <div class="col-md-12 mt-3">
                                                <label for="order"> Order <span class="text-danger">*</span></label>
                                                {!! Form::text('order', $testimonial->order, ['class' => 'form-control numeric', 'id' => 'order', 'placeholder' => 'Order', ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ asset('admin-assets/js/testimonials/testimonials.js') }}"></script>
