...
@section('page-title', ' Edit Achievement | '.__('language.page_main_title').'')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="container-fluid mt2">
                        ...
                        <div class="form pb-2">
                            {!! Form::open(['class' => 'achievement-form', 'method' => 'post', 'url' => route('nutritionPanel.achievements.update', ['id' => ev($achievement->id)]), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    
                                    @php
                                        $imagePath = (get_image_url(config('constants.achievements.image_path'), $achievement->image) ?? '');
                                    @endphp
                                    ...
                                    <div class="col-md-3">
                                        <div class="custom-dropify">
                                            ...
                                            {!! Form::hidden('image_name', old('image_name', ($achievement->image ?? null)) ,['class' => 'form-control','id' => 'image_name']) !!}
                                        </div>
                                    </div>
                                        ...
                                        <div class="row pr-3">
                                            ...
                                            <div class="row p-3 align-items-end">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    {!! Form::select('show_achievement', create_select_options(config('constants.show_achievement'), 'display', 'value', 'Select Show Achievement'), $achievement->show_achievement, ['class' => 'form-control select-picker', 'id' => 'show_achievement' ]) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {!! Form::text('order', $achievement->order, ['class' => 'form-control numeric', 'id' => 'order', 'placeholder' => 'Order', ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
