                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('nutritionPanel.achievements.getAchievements') }}"  data-change-status-url="{{ route('nutritionPanel.achievements.changeStatus') }}" data-destroy-url="{{ route('nutritionPanel.achievements.destroy') }}" data-update-order-url="{{ route('nutritionPanel.achievements.updateOrder') }}">
                                <thead>
                                    <tr>
