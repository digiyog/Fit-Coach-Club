...
@section('content')
    ...
    <div class="layout-px-spacing">
        ...
        <div class="row align-strech mt-5">
                        ...
                        <div class="widget-content">
                            <div class="w-content">
                                <div class="w-info w-100 p-3">
                                    ...
                                    <h4 class="text-dark font-weight-bold">{{ (($lastRecord['weight'] ?? 0) - ($secondLastRecord['weight'] ?? 0)) * 1000 }} gram</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="widget-content">
                            <div class="w-content">
                                <div class="w-info w-100 p-3">
                                    ...
                                    <h4 class="text-dark font-weight-bold">{{ ($user['current_weight'] ?? 0) - ($lastRecord['weight'] ?? 0) }} Kg</h4>
                                </div>
                            </div>
                        </div>
                    </div>
