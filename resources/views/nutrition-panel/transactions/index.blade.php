                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('nutritionPanel.transactions.getTransactions') }}">
                                <thead>
                                    <tr>
                                        <th>User Name</th>
                                        <th>Order Number</th>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th id="due_amount_footer"></th>
                                        <th id="received_amount_footer"></th>
                                        <th colspan="2"></th>
                                    </tr>
                                </tfoot>
                            </table>
