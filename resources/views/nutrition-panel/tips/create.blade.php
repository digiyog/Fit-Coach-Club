...
@section('page-title', ' Create Tip | '.__('language.page_main_title').'')
                    ...
                    <div class="container-fluid mt2">
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-8">
                                <h4> Create Tip (Youtube Links)</h4>
                            </div>
                        </div>

                        <div class="form pb-2">
                            {!! Form::open(['class' => 'tip-form', 'method' => 'post', 'url' => route('nutritionPanel.tips.store'), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        {!! Form::text('link', '', ['class' => 'form-control', 'id' => 'link', 'placeholder' => 'https://www.youtube.com/watch?v=_X1nGnrHhDI Enter only id after =' ]) !!}
                                    </div>

                                    <div class="col-md-12 mt-3">
                                        <label for="coach_name">Coach Name <span class="text-danger">*</span></label>
                                        {!! Form::text('coach_name', '', ['class' => 'form-control', 'id' => 'coach_name', 'placeholder' => 'Coach Name', ]) !!}
                                    </div>
