...
@section('page-title', 'Custom Dishes | '.__('language.page_main_title').'')
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('nutritionPanel.custom-dishes.getCustomDishes') }}"  data-change-status-url="{{ route('nutritionPanel.custom-dishes.changeStatus') }}" data-destroy-url="{{ route('nutritionPanel.custom-dishes.destroy') }}" data-update-order-url="{{ route('nutritionPanel.custom-dishes.updateOrder') }}">
                                <thead>
                                    <tr>
...
<script src="{{ asset('admin-assets/js/custom-dishes/view.js') }}"></script>
@endpush
