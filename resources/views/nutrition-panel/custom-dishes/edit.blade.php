                    ...
                    <div class="container-fluid mt2">
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-8">
                                <h4> Edit Custom Dish </h4>
                            </div>
                        </div>

                        <div class="form pb-2">
                            {!! Form::open(['class' => 'custom-dish-form', 'method' => 'post', 'url' => route('nutritionPanel.custom-dishes.update', ['id' => ev($customDish->id)]), 'enctype' => 'multipart/form-data', 'autocomplete' => 'off' ]) !!}
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row pe-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                {!! Form::select('dish_type_id', create_select_options($dishTypes, 'name', 'id', 'Select Dish Type'), $customDish->dish_type_id, ['class' => 'form-control select-picker', 'id' => 'dish_type_id' ]) !!}
                                            </div>

                                            <div class="col-md-12 mt-3">
                                                <label for="order"> Order <span class="text-danger">*</span></label>
                                                {!! Form::text('order', $customDish->order, ['class' => 'form-control numeric', 'id' => 'order', 'placeholder' => 'Order', ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('description', $customDish->description, ['class' => 'form-control textarea-height editor-textarea', 'id' => 'description', 'placeholder' => 'Description', 'rows' => 5 , "cols" => 40 ]) !!}
                                        </div>
                                    </div>
                                </div>
