...
<div class="header-container fixed-top">
    <header class="header navbar navbar-expand-sm py-0">
        ...
        <ul class="navbar-item flex-row  text-center">
            <li class="nav-item">
                <a href="{{ route('nutritionPanel.dashboard') }}" class="nav-link">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div class="">
                        <div class="dropdown-item">
                            <a class="" href="{{ route('nutritionPanel.profile') }}"> <i data-feather="user"></i> My Profile</a>
                        </div>
                        <div class="dropdown-item">
                            <a class="" href="{{ route('nutritionPanel.logout') }}"> <i data-feather="log-out"></i> Sign Out</a>
                        </div>
                    </div>
                </div>
            </li>
