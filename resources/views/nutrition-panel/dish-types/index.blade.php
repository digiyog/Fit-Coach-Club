                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('nutritionPanel.dish-types.getDishTypes') }}"  data-change-status-url="{{ route('nutritionPanel.dish-types.changeStatus') }}" data-destroy-url="{{ route('nutritionPanel.dish-types.destroy') }}" data-update-order-url="{{ route('nutritionPanel.dish-types.updateOrder') }}">
                                <thead>
                                    <tr>
