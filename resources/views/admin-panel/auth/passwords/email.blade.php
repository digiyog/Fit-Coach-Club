...
<div class="modern-auth-wrapper admin-theme">
    <div class="modern-auth-card">
        ...
        <div class="auth-header">
            <div class="auth-logo-badge admin" style="background: #000000; border-radius: 14px; padding: 6px; width: 48px; height: 48px; display: inline-flex; align-items: center; justify-content: center; box-shadow: 0 4px 14px rgba(0,0,0,0.25); border: 1px solid rgba(255,255,255,0.15);">
        ...
        {!! Form::open(['class' => 'text-start login-form', 'url' => route('adminPanel.passwordEmail'), ]) !!}
            ...
            <div style="text-align: center; margin-top: 18px;">
                <a href="{{ route('adminPanel.login') }}" style="color: #4f46e5; font-size: 13px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
