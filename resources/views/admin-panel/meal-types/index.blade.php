...
@section('page-title', 'Meal Types | '.__('language.page_main_title').'')
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('adminPanel.meal-types.getMealTypes') }}"  data-change-status-url="{{ route('adminPanel.meal-types.changeStatus') }}" data-destroy-url="{{ route('adminPanel.meal-types.destroy') }}" data-update-order-url="{{ route('adminPanel.meal-types.updateOrder') }}">
                                <thead>
                                    <tr>
...
<script src="{{ asset('admin-assets/js/meal-types/view.js') }}"></script>
@endpush
