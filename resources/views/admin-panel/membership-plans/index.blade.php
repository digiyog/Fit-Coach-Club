                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('adminPanel.membership-plans.getMembershipPlans') }}"  data-change-status-url="{{ route('adminPanel.membership-plans.changeStatus') }}" data-destroy-url="{{ route('adminPanel.membership-plans.destroy') }}" data-update-order-url="{{ route('adminPanel.membership-plans.updateOrder') }}">
                                <thead>
                                    <tr>
...
<script src="{{ asset('admin-assets/js/membership-plans/view.js') }}"></script>
@endpush
