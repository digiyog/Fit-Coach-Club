...
@section('page-title', 'Product Types | '.__('language.page_main_title').'')
                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="table-responsive data-table-container mb-4 mt-2">
                        <div class="table-responsive _mb-4">
                            <table id="dataTable" class="table table-hover" data-url="{{ route('adminPanel.product-types.getProductTypes') }}"  data-change-status-url="{{ route('adminPanel.product-types.changeStatus') }}" data-destroy-url="{{ route('adminPanel.product-types.destroy') }}">
                                <thead>
                                    <tr>
...
<script src="{{ asset('admin-assets/js/product-types/view.js') }}"></script>
@endpush
