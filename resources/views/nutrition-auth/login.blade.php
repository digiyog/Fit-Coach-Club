                ...
                <div class="hero-brand-header">
                    <div class="hero-brand-logo">
                        <svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="brandSparkGradNutri" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stop-color="#38bdf8"/>
                                    <stop offset="50%" stop-color="#818cf8"/>
                                    <stop offset="100%" stop-color="#c084fc"/>
                                </linearGradient>
                                <linearGradient id="sparkAccentNutri" x1="100%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stop-color="#ffffff"/>
                                    <stop offset="100%" stop-color="#38bdf8"/>
                                </linearGradient>
                            </defs>
                            <path d="M19 2L22.8 14.2L35 18L22.8 21.8L19 34L15.2 21.8L3 18L15.2 14.2L19 2Z" fill="url(#brandSparkGradNutri)"/>
                            <path d="M19 6L21.5 15.5L31 18L21.5 20.5L19 30L16.5 20.5L7 18L16.5 15.5L19 6Z" fill="url(#sparkAccentNutri)" opacity="0.85"/>
                        </svg>
                    </div>
                ...
                <div class="hero-dashboard-preview">
                    ...
                    <div class="dashboard-chart-container">
                        <svg class="dashboard-svg-chart" viewBox="0 0 500 75" preserveAspectRatio="none">
                            <defs>
                                <linearGradient id="chartAreaGradNutri" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stop-color="#38bdf8" stop-opacity="0.35"/>
                                    <stop offset="100%" stop-color="#38bdf8" stop-opacity="0.0"/>
                                </linearGradient>
                                <linearGradient id="chartLineGradNutri" x1="0%" y1="0%" x2="100%" y2="0%">
                                    <stop offset="0%" stop-color="#38bdf8"/>
                            ...
                            <!-- Fill -->
                            <path d="M 10 60 Q 60 56 100 48 T 190 28 T 275 54 T 360 52 T 440 38 T 490 22 L 490 75 L 10 75 Z" fill="url(#chartAreaGradNutri)" />
                            <!-- Stroke Line -->
                            <path d="M 10 60 Q 60 56 100 48 T 190 28 T 275 54 T 360 52 T 440 38 T 490 22" fill="none" stroke="url(#chartLineGradNutri)" stroke-width="2.5" stroke-linecap="round" />
                            <!-- Nodes -->
    ...
    <div class="auth-form-pane">
        <div class="modern-auth-card-elevated">
            ...
            <div class="auth-card-header">
                ...
                <div>
                    <span class="portal-role-badge coach">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                            <circle cx="9" cy="7" r="4"></circle>
                            <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
            ...
            <!-- Form -->
            {!! Form::open(['class' => 'text-start login-form login-form-body', 'url' => route('nutritionPanel.login')]) !!}
                ...
                <div class="form-options-row">
                    ...
                    <a href="mailto:support@fitcoachclub.com?subject=Password%20Reset%20Request" class="forgot-password-link">
                        Forgot password?
                    </a>
                </div>
